...
const updateEmpresa = (req, res) => {
    ...
    const sql = "UPDATE empresas SET nombre_empresa = ?, password_empresa = ?, email_empresa = ?, pais_org = ?, provincia_org = ?, ciudad_org = ?, descripcion_empresa = ? WHERE organizacion_id = ?";
