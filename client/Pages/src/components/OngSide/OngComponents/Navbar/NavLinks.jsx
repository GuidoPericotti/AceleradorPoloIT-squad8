...
//             <NavLink
//                 className="text-slate-500 me-4 flex items-center text-secondary-500 transition duration-200 hover:text-secondary-600/70 focus:text-secondary-600/70 active:text-secondary-600/70 dark:text-secondary-500 dark:hover:text-secondary-500/80 dark:focus:text-secondary-500/80 dark:active:text-secondary-500/80"
//                 to="/notifications"
...
//                     </svg>
//                 </span>
//                 <span className="absolute -mt-4 ms-2.5 rounded-full bg-danger px-[0.35em] py-[0.15em] text-[0.6rem] font-bold leading-none  text-rose-600 dark:text-rose-600">
//                     1
//                 </span>
//             </NavLink>

//             </li>
//             <li className="mt-1 lg:mb-0 lg:pe-2">
//                 <NavLink
//                 className="text-slate-500 me-4 flex items-center text-secondary-500 transition duration-200 hover:text-secondary-600/70 focus:text-secondary-600/70 active:text-secondary-600/70 dark:text-secondary-500 dark:hover:text-secondary-500/80 dark:focus:text-secondary-500/80 dark:active:text-secondary-500/80"
//                 to="/notifications"
//                 id="dropdownMenuButton1"
...
//             </NavLink>
//             </li>
//             <li className="mb-6 lg:mb-0 lg:pe-2">
//                 <NavLink
