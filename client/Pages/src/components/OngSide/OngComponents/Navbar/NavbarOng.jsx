...
//   return (
//     <header className="fixed top-0 w-full z-50 bg-zinc-50 dark:bg-gray-900 shadow">
...
export const NavbarOng = ({ isModalOpen, darkMode, setDarkMode }) => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 ${darkMode ? 'bg-gray-900' : 'bg-zinc-50'} shadow`}>
      <nav className={`flex items-center justify-between w-full h-16 px-4 ${isModalOpen ? 'filter blur-sm' : ''}`}>
        <div className="flex items-center justify-between w-full">
          {/* Logo */}
          <Logo />
