...
//     `}>
//       <h3 className={`text-2xl font-semibold ${darkMode ? 'text-white' : 'text-[#1e1e1e]'}`} id='nombre_empresa'>
//       {`Sobre ${nombre_empresa}`}
//       </h3>
//       <p className={`mt-4 text-base ${darkMode ? 'text-gray-300' : 'text-[#1e1e1e]'}`} id='descripcion_empresa'>
//       {` ${descripcion_empresa}`}
//       </p>
//     </section>
//   );
