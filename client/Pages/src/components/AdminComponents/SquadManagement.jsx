...
const SquadManagement = () => {
  ...
  return (
    <div className={`admlg:-mt-20 ${darkMode ? 'bg-gray-800'  : 'bg-white text-gray-900'} dark:bg-gray-800 w-full min-h-screen`}>
      ...
      <section>
        ...
        <div className="w-[884px] grid grid-cols-1 adms:grid-cols-2 admlg:grid-cols-3 admlg:gap-5 adms:gap-2 admlg:mt-44 admlg:ml-60 adms:ml-32 adms:mt-24">
          {squads.map((squad) => (
            <div
              key={squad.id}
