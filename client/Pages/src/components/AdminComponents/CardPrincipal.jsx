...
const CardPrincipal = ({ darkMode }) => {
  ...
  return (
    <div className="relative min-h-screen dark:bg-gray-800 adms:right-[1px] admlg:right-[1px]">
      {/* Sidebar fijo */}
      ...
      <div className="ml-[10px] pt-20 ">
        {/* Header */}
        <main className="admlg:w-[1170px] sticky top-[80px] z-0 flex items-center bg-gradient-to-r from-[#76B596] via-[#41849D] to-[#034AA6] p-4 w-[90%] rounded-t-3xl dark:bg-gray-600 flex-col sm:flex-row justify-center mx-auto">
