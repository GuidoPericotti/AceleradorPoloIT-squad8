        ...
        {isOpen && (
          <div className="admlg:hidden mt-2 pb-4">
            <ul className="flex flex-col space-y-2">
              ...
              <li><NavLink to='/proyectos' onClick={toggleMenu} className="block px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">Proyectos</NavLink></li>
              <li><NavLink to='/participantes' onClick={toggleMenu} className="block px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">Participantes</NavLink></li>
              <li><NavLink to='/mentores' onClick={toggleMenu} className="block px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">Mentores</NavLink></li>
              <li><NavLink to='/contact' onClick={toggleMenu} className="block px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">Contacto</NavLink></li>
            </ul>
